...
#undef main
#include "../../fusionfix-source/source/HeadlightCasterPolicy.hpp"
#include "../../fusionfix-source/source/ShadowCasterCE.hpp"
#include "../../fusionfix-source/source/ShadowGuardDiagnostics.hpp"
